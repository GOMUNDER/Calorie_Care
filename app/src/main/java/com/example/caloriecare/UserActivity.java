...
public class UserActivity
{
    ...
    public UserActivity(String fullName, String email, String identity, String phoneNumber, String address, String weight) {
    ...
    public UserActivity ()//這個不要刪，是拿來讀取firebase的
    {
